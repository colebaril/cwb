...
The `cwb` package is a personal library of functions, ggplot2 themes, and palettes that I reach for often in data analysis and visualization. Instead of re-writing code across projects, I can now use my favorite utilities directly from this package.

## Installation

You can install the development version of cwb from [GitHub](https://github.com/) with:
...
pre-formatted with icons and social media tags.
...
Using the `cwb::cite_packages()` function, you can easily cite all packages used in
